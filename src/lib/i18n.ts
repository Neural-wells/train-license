...
export const T: Dict = {
  ...
  examIntro: {
    nl: "50 vragen, net als op het echte examen. Je slaagt vanaf 41/50. Een fout op een vraag over een zware overtreding of snelheid kost 5 punten.",
    fr: "50 questions, comme au vrai examen. Réussite à partir de 41/50. Une erreur sur une question d'infraction grave ou de vitesse coûte 5 points.",
    en: "50 questions, just like the real exam. You pass from 41/50. A mistake on a serious-offence or speeding question costs 5 points.",
  },
